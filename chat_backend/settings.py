...
MAX_UPLOAD_FILE_BYTES = int(
    os.getenv("MAX_UPLOAD_FILE_BYTES", str(2 * 1024 * 1024 * 1024))
)
UPLOAD_SESSION_TTL_HOURS = int(os.getenv("UPLOAD_SESSION_TTL_HOURS", "24"))
MAX_UPLOAD_CHUNKS = int(os.getenv("MAX_UPLOAD_CHUNKS", "8192"))
MAX_UPLOAD_CHUNK_BYTES = int(
    os.getenv("MAX_UPLOAD_CHUNK_BYTES", str(4 * 1024 * 1024 + 128))
)
MAX_CONCURRENT_UPLOAD_SESSIONS = int(
    os.getenv("MAX_CONCURRENT_UPLOAD_SESSIONS", "8")
)
